...
header("Content-Security-Policy-Report-Only:default-src 'self'; script-src 'self';child-src 'self';font-src 'self';style-src 'self' ");
...
// include config file
//require(MY_ROOT . "/config/config.php");
